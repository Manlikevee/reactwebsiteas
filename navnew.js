...
import { header } from './navnew.module.css'
import { row } from './navnew.module.css'
import { container } from './navnew.module.css'
import { logo } from './navnew.module.css'
import { nav } from './navnew.module.css'
      ...
      <div className={row}>
        ...
        <nav className={nav}>
          <ul>
            ...
            <li>
              <a href="digitalproduct.html">Solutions</a>
            </li>
            <li>
              <a href="digitalproduct copy 2.html">Technologies</a>
            </li>
            <li>
